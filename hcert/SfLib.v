(**
    The following useful Coq tactics, theorems and propositions have been adapted from the
    online electronic textbook %\textbf{Software Foundations}% %\cite{pierce2013software}%. 
*)
...
Tactic Notation "normalize" := 
   repeat (print_goal; eapply multi_step ; 
             [ (info_eauto 20; fail) | (instantiate; simpl)]);
   apply multi_refl.
